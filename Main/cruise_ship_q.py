...
def initialize_system():
    ...
    return (today_date, tables_available, 
            lunch_bookings, early_dinner_bookings, late_dinner_bookings,
            lunch_names, early_dinner_names, late_dinner_names,
            lunch_cabins, early_dinner_cabins, late_dinner_cabins,
            lunch_dietary, early_dinner_dietary, late_dinner_dietary,
            vegetarian_count, vegan_count)
...
def make_booking(tables_available, session_bookings, session_names, 
                 session_cabins, session_dietary, vegetarian_count, vegan_count):
    ...
    # Get cabin number
    cabin = get_valid_input("Enter cabin number: ", 
                            lambda x: len(x) > 0 and len(x) <= 10)
...
def main():
    ...
    (today_date, tables_available, 
     lunch_bookings, early_dinner_bookings, late_dinner_bookings,
     lunch_names, early_dinner_names, late_dinner_names,
     lunch_cabins, early_dinner_cabins, late_dinner_cabins,
     lunch_dietary, early_dinner_dietary, late_dinner_dietary,
     vegetarian_count, vegan_count) = initialize_system()
    ...
    while True:
        ...
        if choice == "1":
            tables_available, vegetarian_count, vegan_count = make_booking(
                tables_available, session_bookings, session_names, 
                session_cabins, session_dietary, vegetarian_count, vegan_count
            )
        elif choice == "2":
