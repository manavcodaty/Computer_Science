ticket_type = [
    ...
    "Group of Six or more, price per person",
]
...
def validation():
    if (
        ...
        or "One Child (An adult may bring up to two children)"
        or "One Senior"
        or "Family Ticket (Up to two adults or seniors, and three children )"
        or "Group of Six or more, price per person"
    ):
        print("Invalid ticket type")
        add_info()
    elif (
        extra_attractions != "Lion feeding"
        or "penguin feeding"
        or "Evening barbecue (two day tickets only)"
    ):
