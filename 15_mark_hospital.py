...
def hospital(patient_num):
    if patient_num < 1 or patient_num > 4:  # Checking patient number
        print("Invalid patient number")
    else:
        print("Patient: ", patient[patient_num - 1])
        for i in range(Readings[patient_num - 1][0]):
            if (
                Readings[patient_num - 1][0] >= 37.2
                or Readings[patient_num - 1][1] <= 31.6
            ):
                print("Warning")
            ...
            if (
                Readings[patient_num - 1][1] >= 100
                or Readings[patient_num - 1][1] <= 55
            ):
                print("Warning")
